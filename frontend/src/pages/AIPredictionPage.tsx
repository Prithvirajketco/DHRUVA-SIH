      ...
      <div className="bg-white rounded-2xl p-6 mb-8 shadow-soft border border-slate-100">
        <div className="flex flex-col xl:flex-row items-start xl:items-center gap-6">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 shrink-0">
            ...
            <span className="text-xs font-semibold text-slate-400 sm:ml-2">(applies extra rainfall to all stations)</span>
          </div>
          <div className="w-full xl:flex-1 min-w-0 flex flex-col sm:flex-row sm:items-center gap-4">
            <div className="relative flex-1 w-full h-3 bg-slate-100 rounded-full border border-slate-200 mt-2 sm:mt-0">
            ...
            <input
              ...
              className="absolute opacity-0 w-full cursor-pointer h-3"
              style={{ position: 'relative', marginTop: '-12px', zIndex: 10 }}
            />
            <span className={`text-base font-black text-center sm:text-left w-full sm:w-20 ${rainfallBoost > 100 ? 'text-red-500' : rainfallBoost > 50 ? 'text-yellow-500' : 'text-blue-500'}`}>
              +{rainfallBoost}mm
            </span>
          </div>
          <div className="flex flex-wrap gap-2 w-full xl:w-auto shrink-0 justify-center sm:justify-start">
